...
test.describe('HeroCards Component', () => {
    ...
    test('should show pop card ', async ({ page }) => {
        await page.goto("http://localhost:3000");
        await page.locator('[id="choose-what-to"]').type("food");
        // await page.waitForTimeout(2000);  
        await page.locator('[id="choose-location"]').type("delhi");
        // await page.waitForTimeout(2000);  
        await page.locator('[data_Test_Id="Search-Button"]').click();
        // await page.waitForTimeout(2000);  
    ...
    test.skip('testing amanzon website', async ({ page }) => {
